"""
Django settings for device_lifecycle project.
...
SECRET_KEY = 'g%189s-)kgv_fy68fx!5rj=xr-hcq1vj33lon2f+$1c!8ik5%h'
...
DATABASES = {
    'default': dj_database_url.parse(
        os.environ.get('DATABASE_URL', 'sqlite:///./device_lifecycle.db')),
}
